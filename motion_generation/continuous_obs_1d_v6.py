...
def main():
    ...
    for obs_idx,obs_ratio in enumerate(obs_ratio_time):
        ...
        robot_promps = ipromps_set[idx_max_prob].promps[1]
    ...
    plt.title("Trajectory blending",fontsize=25)
    plt.ylabel("X[m]",fontsize=20)
    plt.plot(t,mean0[0:90],label="Predicted trajectory 1",linestyle='-.',color="r",linewidth=2,)
    plt.plot(t,mean1[0:90],label="Predicted trajectory 2",linestyle='-.',color="g",linewidth=2,)
    plt.plot(t,mean2[0:90],label="Predicted trajectory 3",linestyle='-.',color="b",linewidth=2,)
    plt.plot(t,mean3[0:90],label="Predicted trajectory 4",linestyle='-.',color="lime",linewidth=2,)
    plt.plot(t,mean_blending_proc,color="black",label="Blended trajectory",linewidth=3)
    ...
    plt.plot(np.linspace(0,0.3,30),phase_0_proc,color="r",linewidth=3,)
    plt.plot(np.linspace(0,0.6,60),phase_1_proc,color="g",linewidth=3,)
    plt.plot(np.linspace(0.3,0.9,60),phase_2_proc,color="b",linewidth=3,)
    plt.plot(np.linspace(0.6,0.9,30),phase_3_proc,color="lime",linewidth=3,)
